...
install_kcptun_for_ss_ssr(){
        ...
        if check_sys packageManager yum; then
            ...
            apt-get -y update && apt-get -y install --no-install-recommends gettext curl wget vim unzip psmisc gcc swig autoconf automake make perl cpio build-essential libtool openssl libssl-dev zlib1g-dev xmlto asciidoc libpcre3 libpcre3-dev python3 python3-dev python3-pip python-is-python3 libev-dev libc-ares-dev libudns-dev
